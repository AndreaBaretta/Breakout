...
public class BreakoutTest {
    ...
    public static void main(final String[] args) {
        ...
        final Breakout breakout = new Breakout(new File("/home/andrea/Desktop/foxtrotFiles/power_shot_and_wobble_goals_blue_breakout_test.foxtrot2"), 1, new ArrayList<>(),
        ...
        final MecanumKinematics kinematics = new MecanumKinematics(50, Config.MASS, 0.5, 0.5, new Vector3(0,0,0),
                new Vector3(breakout.path.startX, breakout.path.startY,breakout.path.startHeading), window1, Config.J, Config.r_X, Config.r_Y, Config.T_MAX,
