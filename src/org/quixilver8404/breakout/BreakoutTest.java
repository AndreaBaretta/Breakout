...
public class BreakoutTest {
    ...
    public static void main(final String[] args) {
        ...
        final Breakout breakout = new Breakout(new File("/home/andrea/Desktop/foxtrotFiles/tower_shot_and_wobble_goals_blue_breakout.foxtrot2"), 1, new ArrayList<>(),
        ...
        final MecanumKinematics kinematics = new MecanumKinematics(50, Config.MASS, 0.5, 0.5, new Vector3(0,0,0),
                new Vector3(0*Config.INCHES_TO_METERS, 0*Config.INCHES_TO_METERS,0), window1, Config.J, Config.r_X, Config.r_Y, Config.T_MAX,
