...
public class TestPath {
    ...
    public double[] iterate(final Vector3 pos, final Vector3 vel, final double dt) {
        ...
        final Vector3 des_pos = new Vector3(Math.cos(v*t), Math.sin(v*t), -Math.PI/2);
        final Vector3 des_vel = new Vector3(-Math.sin(v*t)*v, Math.cos(v*t)*v, 0);
        final Vector3 des_acc = new Vector3(-Math.cos(v*t)*v*v, -Math.sin(v*t)*v*v, 0);
